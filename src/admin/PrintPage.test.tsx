...
function team(id: string, name: string, code: string): MonitorRow {
  return {
    ...
    last_solve_at: null, wrong_count: 0, current_location: null,
  }
}
...
describe('PrintPage', () => {
  it('groups the slips by location, one per team, and each code once', async () => {
    ...
    // One final-level slip per team, at whichever location ends its route.
    expect(screen.getAllByText(/final treasure/i)).toHaveLength(2)
  })
